...
namespace CMD.SystemClass
{
    public class SystemConfig
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public int Numofbtn_perrows
        {
            get { return _Numofbtn_perrows; }
            set { _Numofbtn_perrows = value; }
        }
        ...
        public void Init(string Version, int Schedule, int Numofbtn_perrows, int NumofgridviewPage_perrows, int SelectTopN, string C_DBConnstring,
        string SystemHashAlg, string SystemDateTimeFormat, string SplitSymbol, string SplitSymbol2, string SplitSymbol3,
        int btnWidth, int btnHeight, int xoffset, int yoffset,
        int PublicRoleID,
        ...
        string TextSubject, string TextBody)
        {
            ...
            this.Numofbtn_perrows = Numofbtn_perrows;
        ...
        public void Init()
        {
            ...
            this.Numofbtn_perrows = Convert.ToInt16(WebConfigurationManager.AppSettings["Numofbtn_perrows"]);
            ...
            this.btnWidth = Convert.ToInt16(WebConfigurationManager.AppSettings["btnWidth"]);
            this.btnHeight = Convert.ToInt16(WebConfigurationManager.AppSettings["btnHeight"]);
            this.xoffset = Convert.ToInt16(WebConfigurationManager.AppSettings["xoffset"]);
            this.yoffset = Convert.ToInt16(WebConfigurationManager.AppSettings["yoffset"]);
